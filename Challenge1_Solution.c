...
cd "d:\Coding\C Projects\1. Data Packet Corruption Detection\" ; if ($?) { gcc Challenge1_Solution.c -o Challenge1_Solution } ; if ($?) { .\Challenge1_Solution }
1. Transmitting data packet:
Transmitting data packet...
Packet ID: 1
Data Length: 10
Data: 12 34 56 78 9A BC DE F0 11 22
CRC: FB31
Packet transmission complete.
-----------------------------
2. Received data packet:
Packet ID: 1
Data Length: 10
Data: 12 34 56 78 9A BC DE F0 11 22
CRC: FB31
...
-----------------------------
3. Data packet corruption status: Data packet valid.
-----------------------------
...
Packet transmission complete.
-----------------------------
Data packet corrupted! Discarding...
2. Received data packet:
Packet ID: 0
Data Length: 242
Data:
...
Packet received successfully.
-----------------------------
3. Data packet corruption status: Data packet corrupted!
-----------------------------
